...
$(LIBGRPC_OBJS): CPPFLAGS += $(if $(subst SunOS,,$(SYSTEM)),, -DBSD_COMP) 
...
$(LIBARES_OBJS): CPPFLAGS += -Ithird_party/cares -Ithird_party/cares/cares $(if $(subst Linux,,$(SYSTEM)),,-Ithird_party/cares/config_linux) $(if $(subst Darwin,,$(SYSTEM)),,-Ithird_party/cares/config_darwin) $(if $(subst SunOS,,$(SYSTEM)),,-Ithird_party/cares/config_sunos -DBSD_COMP) -fvisibility=hidden -D_GNU_SOURCE -DWIN32_LEAN_AND_MEAN -D_HAS_EXCEPTIONS=0 -DNOMINMAX $(if $(subst MINGW32,,$(SYSTEM)),-DHAVE_CONFIG_H,)
